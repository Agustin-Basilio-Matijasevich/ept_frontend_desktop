...
class FormInscripcion {
  ...
  static FormInscripcion? fromJson(Map<String,dynamic> json)
  {
    try
    {
      ...
      final DateTime fecha_nacimiento_alumno = DateTime.parse(json['fecha_nacimiento_alumno'].toString());
      final NivelEducativo nivel = NivelEducativo.values.firstWhere((element) => element.toString() == json['nivel']);
      
      return FormInscripcion(apellido_alumno, apellido_tutor, nombre_alumno, nombre_tutor, email_tutor, anio_lectivo, dni_alumno, dni_tutor, fecha_nacimiento_alumno, nivel);
    }
    catch (e)
    {
