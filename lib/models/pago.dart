...
class Pago{
  ...
  static Pago? fromJson(Map<String,dynamic> json)
  {
    try
    {
      final TipoPago tipoPago = TipoPago.values.firstWhere((element) => element.toString() == json['tipopago']);
  ...
  {
    return {'tipopago' : tipoPago.toString(), 'monto' : monto.toString(), 'fecha' : fecha.toIso8601String()};
  }
